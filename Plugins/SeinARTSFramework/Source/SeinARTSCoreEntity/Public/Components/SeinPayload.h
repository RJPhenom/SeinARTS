 ...
 *          etc.) should inherit from FSeinPayload. It inherits FTableRowBase
...
#include "SeinPayload.generated.h"

USTRUCT(BlueprintType)
struct SEINARTSCOREENTITY_API FSeinPayload : public FTableRowBase
{
	GENERATED_BODY()
};
