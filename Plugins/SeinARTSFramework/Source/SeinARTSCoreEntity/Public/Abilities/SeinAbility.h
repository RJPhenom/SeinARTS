...
public:
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "SeinARTS",
		AdvancedDisplay)
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SeinARTS|Cost")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SeinARTS|Dispatch")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SeinARTS|Targeting")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SeinARTS|Arbitration")
