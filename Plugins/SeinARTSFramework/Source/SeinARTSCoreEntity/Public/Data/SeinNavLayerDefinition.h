 ...
 *          on `FSeinNavigationPayload::NavLayerMask` and `FSeinExtentsPayload::
 *          BlockedNavLayerMask`.
 *
 ...
 *  - LayerName is displayed in the bitmask combos on FSeinNavigationPayload and
 *    FSeinExtentsPayload (BlockedNavLayerMask) for designer clarity.
