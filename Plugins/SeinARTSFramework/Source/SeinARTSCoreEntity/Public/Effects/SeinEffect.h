...
public:
	...
	/** Optional display name for effect lists and tooltips. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "General")
	FText DisplayName;

	/** Optional description for effect tooltips. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "General", meta = (MultiLine = "true"))
	FText Description;

	/** Optional icon for effect lists and status indicators. Production queues use the queued entity's identity. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "General")
