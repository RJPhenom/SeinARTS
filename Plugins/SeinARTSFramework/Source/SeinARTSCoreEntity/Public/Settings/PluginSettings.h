...
public:
	 ...
	 *  element hooks for a fully custom backend. None = opted-in units fall back to the framework base
	 *  renderer (`Sein.Preview.Disable 1` is the dev toggle for suppressing the drawing entirely). */
	UPROPERTY(Config, EditAnywhere, Category = "Navigation|Formation",
