 ...
 *
 * @file         SeinNavigationRendererComponent.h
 * @author       RJ Macklem
 * @created      02 Sep 2026
 * @latest       05 Sep 2026
 ...
 *
 *               The C++ class name is designer-facing: the Components panel derives
 *               the node's variable name from it ("SeinNavigationRenderer") while
 *               DisplayName only labels the Add menu, so both must say Navigation
 *               Renderer.
 *
...
#include "SeinNavigationRendererComponent.generated.h"
...
class SEINARTSFRAMEWORK_API USeinNavigationRendererComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	USeinNavigationRendererComponent();
