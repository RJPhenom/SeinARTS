...
namespace UE::SeinARTSTests
{
	...
	TEST(SnapshotV13EnvelopeHasFrozenBigEndianFramingAndCanonicalOrder,
		"SeinARTS.Unit.CoreEntity.SnapshotEnvelope")
	{
		...
		ASSERT_THAT(AreEqual(
			FString(TEXT("2EDEFC9B695E7E028779E54F1C93E8CB")),
		...
		ASSERT_THAT(AreEqual(
			FString(TEXT(
				"5B8C588BD42495E99A2057C503BDB1B7"
				"6BB1C4EBAFFF6081A24460EDE2EE0B03")),
	...
	TEST(SnapshotV13AggregateRootIncludesOnlyFutureAffectingSections,
		"SeinARTS.Unit.CoreEntity.SnapshotEnvelope")
	{
	...
	TEST(SnapshotV13EmptyEnvelopeRoundTripsWithoutExposingOutputsOnFailure,
		"SeinARTS.Unit.CoreEntity.SnapshotEnvelope")
	{
	...
	TEST(SnapshotV13PrefixRejectsHostileBoundsBeforeBodyDecode,
	...
	TEST(SnapshotV13RejectsNoncanonicalDirectoriesAndDigestForgeries,
		"SeinARTS.Unit.CoreEntity.SnapshotEnvelope.Security")
	{
		const FSeinSnapshotEnvelope Source = MakeCanonicalFixture();
		TArray<uint8> Clean;
