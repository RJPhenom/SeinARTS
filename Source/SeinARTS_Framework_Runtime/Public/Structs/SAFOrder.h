...
struct SEINARTS_FRAMEWORK_RUNTIME_API FSAFOrder {
	...
	UPROPERTY(BlueprintReadWrite) TSoftObjectPtr<USAFUnitData> TargetData = nullptr;
	...
	FSAFOrder() {}
	FSAFOrder(AActor* InTarget, TSoftObjectPtr<USAFUnitData> InTargetData, const FVector& InStart, const FVector& InEnd, FGameplayTag Tag = FGameplayTag())
