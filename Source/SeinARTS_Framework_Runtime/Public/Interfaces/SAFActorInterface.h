...
#include "SAFAssetInterface.generated.h"

class ASAFActor;
class ASAFFormationManager;

UINTERFACE(Blueprintable) 
class SEINARTS_FRAMEWORK_RUNTIME_API USAFAssetInterface : public UInterface { GENERATED_BODY() };

/**
 * SAFAssetInterface
 * 
 * The SAFAssetInterface is the primary means of communication with assets in the
 * SeinARTS Framework. Implement this interface on a class to give it methods to 
 * seed with and get elements of a SAFAsset.
 */
class SEINARTS_FRAMEWORK_RUNTIME_API ISAFAssetInterface {
    GENERATED_BODY()
