...
// ====================================================================================================================
// Sets the data asset on this instance and reinitializes.
void ASAFActor::SetAsset_Implementation(USAFAsset* InAsset) {
  Asset = InAsset;
  ASAFPlayerState* MyOwner = ISAFAssetInterface::Execute_GetOwningPlayer(this);
  ISAFAssetInterface::Execute_InitAsset(this, InAsset, MyOwner);
}
...
void ASAFActor::InitAsset_Implementation(USAFAsset* InAsset, ASAFPlayerState* InOwner) {
  ...
  ISAFAssetInterface::Execute_SetOwningPlayer(this, ResolvedOwner);
  ForceNetUpdate();
}
