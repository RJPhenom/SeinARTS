...
void ASAFUnit::SetAsset_Implementation(USAFAsset* InAsset) {
  ...
  Asset = InAsset;
  ASAFPlayerState* InOwner = ISAFAssetInterface::Execute_GetOwningPlayer(this);
  ISAFAssetInterface::Execute_InitAsset(this, InAsset, InOwner);
}
...
// ============================================================================================================================================
// Attaches this Unit Actor (which does not stream movement via replication) to 
// a pawn which represents the moving unit (and has an AI controller and so on).
