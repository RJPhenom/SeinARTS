...
USAFAsset* ASAFSquadMember::GetAsset_Implementation() const {
	...
	if (IsValid(MySquad)) return ISAFAssetInterface::Execute_GetAsset(MySquad);
...
ASAFPlayerState* ASAFSquadMember::GetOwningPlayer_Implementation() const {
	ASAFSquad* MySquad = ISAFSquadMemberInterface::Execute_GetSquad(this);
	if (IsValid(MySquad)) return Cast<ASAFPlayerState>(ISAFAssetInterface::Execute_GetOwningPlayer(MySquad));
...
bool ASAFSquadMember::GetMultiSelectable_Implementation() const {
	...
	return IsValid(MySquad) ? ISAFAssetInterface::Execute_GetMultiSelectable(MySquad) : false;
}

void ASAFSquadMember::SetMultiSelectable_Implementation(bool bNewMultiSelectable) {
	ASAFSquad* MySquad = ISAFSquadMemberInterface::Execute_GetSquad(this);
	if (IsValid(MySquad)) ISAFAssetInterface::Execute_SetMultiSelectable(MySquad, bNewMultiSelectable);
...
bool ASAFSquadMember::Select_Implementation(AActor*& OutSelectedActor) {
	...
	if (IsValid(MySquad)) return ISAFAssetInterface::Execute_Select(MySquad, OutSelectedActor);
...
bool ASAFSquadMember::QueueSelect_Implementation(AActor*& OutQueueSelectedActor) {
	AActor* MySquad = ISAFSquadMemberInterface::Execute_GetSquad(this);  
	if (IsValid(MySquad)) return ISAFAssetInterface::Execute_QueueSelect(MySquad, OutQueueSelectedActor);
...
void ASAFSquadMember::Deselect_Implementation() {
	AActor* MySquad = ISAFSquadMemberInterface::Execute_GetSquad(this);
	if (IsValid(MySquad)) ISAFAssetInterface::Execute_Deselect(MySquad);
...
void ASAFSquadMember::DequeueSelect_Implementation() {
	AActor* MySquad = ISAFSquadMemberInterface::Execute_GetSquad(this);
	if (IsValid(MySquad)) ISAFAssetInterface::Execute_DequeueSelect(MySquad);
