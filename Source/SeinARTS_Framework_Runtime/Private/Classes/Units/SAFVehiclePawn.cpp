...
void ASAFVehiclePawn::PostInitializeComponents() {
	...
	if(!ISAFAssetInterface::Execute_GetAsset(this)) return;
	ApplyVisuals(); 
  SyncNavAgentWithCapsule();
}
...
USAFAsset* ASAFVehiclePawn::GetAsset_Implementation() const {
  ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) return ISAFAssetInterface::Execute_GetAsset(MyVehicle);
...
void ASAFVehiclePawn::SetMultiSelectable_Implementation(bool bNewMultiSelectable) {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) return ISAFAssetInterface::Execute_SetMultiSelectable(MyVehicle, bNewMultiSelectable);
...
bool ASAFVehiclePawn::Select_Implementation(AActor*& OutSelectedActor) {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) return ISAFAssetInterface::Execute_Select(MyVehicle, OutSelectedActor);
...
bool ASAFVehiclePawn::QueueSelect_Implementation(AActor*& OutQueueSelectedActor) {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) return ISAFAssetInterface::Execute_QueueSelect(MyVehicle, OutQueueSelectedActor);
...
void ASAFVehiclePawn::Deselect_Implementation() {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) ISAFAssetInterface::Execute_Deselect(MyVehicle);
...
void ASAFVehiclePawn::DequeueSelect_Implementation() {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);;
	if (SAFLibrary::IsActorPtrValidSeinARTSUnit(MyVehicle)) ISAFAssetInterface::Execute_DequeueSelect(MyVehicle);
...
ASAFPlayerState* ASAFVehiclePawn::GetOwningPlayer_Implementation() const {
	ASAFVehicle* MyVehicle = ISAFVehiclePawnInterface::Execute_GetVehicle(this);
	if (SAFLibrary::IsActorPtrValidSeinARTSActor(MyVehicle)) return ISAFAssetInterface::Execute_GetOwningPlayer(MyVehicle);
...
USAFVehicleAsset* ASAFVehiclePawn::GetVehicleAsset_Implementation() const {
  ...
  USAFVehicleAsset* VehicleAsset = Cast<USAFVehicleAsset>(ISAFAssetInterface::Execute_GetAsset(Vehicle));
