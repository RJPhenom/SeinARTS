...
Use `WORKFLOW.md` for operational rules. Use the repository and plugin guides for technical invariants. Use the remaining files here for current state, accepted evidence, remaining work, and cross-session handoff context.
...
- Private human documentation belongs in Google Drive. Public documentation belongs in `Docs/` or its designated documentation repository.
